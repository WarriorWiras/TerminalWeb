...
const getPlatform = (): 'Unknown' | 'profile'  => {
  let os: 'Unknown' | 'profile' = 'Unknown';
    os = 'profile';
...
const getArt = () => {
  ...
  switch (platform) {
    case 'profile':
      return `<p style="color: ${mainColor}">${profile}</p>`;
  }
};
...
const getInfo = () => {
  ...
  message += `<link rel='stylesheet' href='https://cdn.jsdelivr.net/npm/bootstrap-icons@1.7.2/font/bootstrap-icons.css'>`
  message += `<span style="color: ${mainColor}"><i class="fa fa-id-card-o"></i> Neofetch</span>: Summary display\n\n`;
  message += `<span style="color: ${mainColor}"><i></i>.....................\n`;
  message += `<span style="color: ${mainColor}"><i class="bi bi-terminal-fill"></i> ABOUT ME</span>\n.....................\n`;
message += `<span style="color: ${mainColor}"><i class="fa fa-user"></i></span> Muhd Wafiyuddin, ${age} years old.\n`;
message += `<span style="color: ${mainColor}"><i class="fa fa-certificate"></i></span> Diploma in Infocomm Security Management\n`;
...
export const Neofetch = neofetch;
export const NEOFETCH = neofetch;
